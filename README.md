...
game:GetService("UserInputService").InputBegan:Connect(function(io, p)
    ...
    if io.KeyCode == getgenv().setting['LockPlayersBind'] then
        ...
        if getgenv().setting['ล็อคเป้า หมาย'] then

            loackplayerslabel.Text = "ล็อคเป้า หมาย | OFF"

            getgenv().setting['ล็อคเป้า หมาย'] = false

            print(getgenv().setting['ล็อคเป้า หมาย'])

        else

            loackplayerslabel.Text = "ล็อคเป้า หมาย | ON"

            getgenv().setting['ล็อคเป้าหมาย'] = true
